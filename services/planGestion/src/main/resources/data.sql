drop table if exists cuenta_categoria;
...
alter table cuenta_categoria add constraint fk_iban_cuenta_cat foreign key (iban_cuenta) references cuentas(iban);
alter table cuenta_categoria add constraint fk_idcat_cuenta_cat foreign key (id_categoria) references categorias(idCat);
...
insert into categorias (idCat, nombre) values(1, 'Pagos y efectivo');
insert into categorias (idCat, nombre) values(2, 'Suministros');
insert into categorias (idCat, nombre) values(3, 'Impuestos');
insert into categorias (idCat, nombre) values(4, 'Vivienda');
insert into categorias (idCat, nombre) values(5, 'Alimentación');
insert into categorias (idCat, nombre) values(6, 'Transporte');
insert into categorias (idCat, nombre) values(7, 'Ocio');
insert into categorias (idCat, nombre) values(8, 'Salud');
insert into categorias (idCat, nombre) values(9, 'Ahorro');
...
insert into cuenta_categoria (iban_cuenta, id_categoria, presupuesto, frecuencia) values ('es111111111111111111', 1, '1000', 'Anual');
insert into cuenta_categoria (iban_cuenta, id_categoria, presupuesto, frecuencia) values ('es222222222222222222', 3, '300', 'Mensual');
